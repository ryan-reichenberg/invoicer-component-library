    ...
    render() {
                ...
                <div>
                    ...
                    <div className="mx-1">
                        { i+1 === this.props.activeStep ? (
                                ...
                                <div className={(i < this.props.activeStep ? 'bg-green-500' : 'bg-gray-200') +' w-2.5 h-2.5 rounded-full flex justify-center items-center'}></div>
                            )
                        }
                    </div>   
        ...
        return (
                ...
                <div className='flex items-center justify-items-center'>
                    <span className='font-bold mr-4 text-sm'>Step {this.props.activeStep} of {this.props.maxSteps}</span>
                        { steps }
                </div>
        )
    }
