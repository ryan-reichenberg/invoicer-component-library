      ...
      >
        <span className="inline-block w-full rounded-md shadow-sm">
          ...
          >
              ...
              <span
                    className={"block truncate text-center text-base pointer-events-none" + (isDropdownOpen ? " hidden" : "")}
                >
                  {validSelectedValue ? (
                  <>
                    <div
                ...
                <input
                        ...
                        className={"w-full h-full border-none focus:outline-none focus:ring-0 p-0 leading-none text-base"}
                        autoFocus={true}
                />
                }
