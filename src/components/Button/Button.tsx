...
export const Button = ({
  ...
  return (
    <button
      type="button"
      className={'align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none '+mode+' '+disabledClasses+' '+sizeClasses}
      onClick={onClick}
      disabled={disabled}
    >
      {label}
